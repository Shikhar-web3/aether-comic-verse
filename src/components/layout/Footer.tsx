      ...
      <div className="container max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2">
              <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-neon-purple via-cyber-pink to-electric-blue p-0.5">
                <div className="w-full h-full bg-cosmic-black rounded-md flex items-center justify-center">
                  <span className="font-orbitron font-bold text-sm text-white">C²</span>
                </div>
              </div>
            ...
            <p className="mt-4 text-sm text-white/60">
              Create, collaborate, and mint comics using AI and Web3 technology.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/explore" className="text-sm text-white/60 hover:text-white transition-colors">Explore Comics</Link></li>
              <li><Link to="/workshop" className="text-sm text-white/60 hover:text-white transition-colors">Workshop</Link></li>
              <li><Link to="/learn" className="text-sm text-white/60 hover:text-white transition-colors">Learn</Link></li>
              <li><Link to="/mint" className="text-sm text-white/60 hover:text-white transition-colors">Mint</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/tutorials" className="text-sm text-white/60 hover:text-white transition-colors">Tutorials</Link></li>
        ...
        <div className="mt-8 pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/40">
            © 2025 ComicCosmos. All rights reserved.
          </p>
